        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4" style={{minHeight: '100vh', background: 'linear-gradient(135deg, #dbeafe 0%, #e0e7ff 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px'}}>
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8" style={{backgroundColor: 'white', borderRadius: '16px', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1)', width: '100%', maxWidth: '448px', padding: '32px', boxSizing: 'border-box'}}>
                <div className="text-center mb-8" style={{textAlign: 'center', marginBottom: '32px'}}>
                    ...
                    <h2 className="text-3xl font-bold text-gray-800 mb-2" style={{fontSize: 'clamp(24px, 5vw, 30px)', fontWeight: 'bold', color: '#1f2937', marginBottom: '8px'}}>Welcome Back</h2>
                    <p className="text-gray-600" style={{color: '#4b5563', fontSize: 'clamp(14px, 3vw, 16px)'}}>Sign in to your Smart Book account</p>
                </div>
                ...
                <div style={{width: '100%', boxSizing: 'border-box'}}>
                    ...
                    <button
                        ...
                        style={{width: '100%', marginTop: '24px', backgroundColor: '#2563eb', color: 'white', paddingTop: '12px', paddingBottom: '12px', borderRadius: '8px', fontWeight: '600', cursor: isLoading ? 'not-allowed' : 'pointer', opacity: isLoading ? 0.5 : 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', border: 'none', transition: 'background-color 0.2s', boxSizing: 'border-box', fontSize: 'clamp(14px, 3vw, 16px)'}}
                ...
                <div className="mt-6 text-center" style={{marginTop: '24px', textAlign: 'center'}}>
                    <p className="text-gray-600" style={{color: '#4b5563', fontSize: 'clamp(12px, 3vw, 14px)'}}>
